...
from .models import GenericPushTarget, BrewersFriendPushTarget, BrewfatherPushTarget, GrainfatherPushTarget
...
def external_push_list(request, context_only=False):
    ...
    context = {'all_push_targets': all_push_targets, 'brewfather_push_targets': brewfather_push_targets,
               'brewers_friend_push_targets': brewers_friend_push_targets, 'grainfather_push_targets': grainfather_push_targets}
