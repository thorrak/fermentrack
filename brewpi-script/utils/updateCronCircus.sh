...
# TODO - Have this script remove any cron entries that were erroneously created for a legacy brewpi install (Maybe??)
# TODO - Convert this script to actually manage the Circus entries
