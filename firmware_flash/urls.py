...
firmware_flash_urlpatterns = [
    ...
    url(r'^firmware/autodetect_serial/(?P<flash_family_id>[A-Za-z0-9]{1,20})/$', firmware_flash.views.firmware_flash_serial_autodetect, name='firmware_flash_serial_autodetect'),
    url(r'^firmware/select_firmware/(?P<flash_family_id>[A-Za-z0-9]{1,20})/$', firmware_flash.views.firmware_flash_select_firmware, name='firmware_flash_select_firmware'),
    url(r'^firmware/flash/(?P<flash_family_id>[A-Za-z0-9]{1,20})/$', firmware_flash.views.firmware_flash_flash_firmware, name='firmware_flash_flash_firmware'),
