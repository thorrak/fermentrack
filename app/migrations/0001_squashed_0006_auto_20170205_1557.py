# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2017-02-05 15:59
...
class Migration(migrations.Migration):
    ...
    replaces = [('app', '0001_squashed_0005_brewpidevice_active_profile'), ('app', '0002_brewpidevice_time_profile_started'), ('app', '0003_auto_20170115_0455'), ('app', '0004_auto_20170129_2351'), ('app', '0005_auto_20170130_0737'), ('app', '0006_auto_20170205_1557')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tempSetMin', models.FloatField(help_text='The fridge and beer temperatures cannot go below this value', verbose_name='Min Temperature')),
                ('tempSetMax', models.FloatField(help_text='The fridge and beer temperatures cannot go above this value', verbose_name='Max Temperature')),
                ...
                ('Ki', models.FloatField(help_text='When the intergral is active, the error is addedto the integral every 30 sec. The result is multipliedby Ki to give the integral part', verbose_name='PID: Ki')),
                ...
                ('idleRangeH', models.FloatField(help_text='When the fridge temperature is within this range, it will not heat or cool, regardless of other setting.', verbose_name='Temperature idle range top')),
                ('idleRangeL', models.FloatField(help_text='When the fridge temperature is within this range, it will not heat or cool, regardless of other setting.', verbose_name='Temperature idle range bottom')),
                ('heatTargetH', models.FloatField(help_text='When the overshoot lands under this value, the peak is within target range and the estimator is not adjusted', verbose_name='Heating target upper bound')),
                ('heatTargetL', models.FloatField(help_text='When the overshoot lands above this value, the peak is within target range and the estimator is not adjusted', verbose_name='Heating target lower bound')),
                ('coolTargetH', models.FloatField(help_text='When the overshoot lands under this value, the peak is within target range and the estimator is not adjusted', verbose_name='Cooling target upper bound')),
                ('coolTargetL', models.FloatField(help_text='When the overshoot lands above this value, the peak is within target range and the estimator is not adjusted', verbose_name='Cooling target lower bound')),
                ('maxHeatTimeForEst', models.FloatField(help_text='The time the fridge has been heating is used to estimate overshoot. This is the maximum time that is tahen into account', verbose_name='Maximum time in seconds for heating overshoot estimator')),
                ('maxCoolTimeForEst', models.FloatField(help_text='Maximum time the frige has been cooling is used to estimate overshoot. This is the maximum time that is taken into account', verbose_name='Maximum time in seconds for cooling overshoot estimator')),
                ('beerFastFilt', models.FloatField(help_text='The beer fast filter is used for display and data logging. More filtering give a smoother line but also more delay', verbose_name='Beer fast filter delay time')),
                ('beerSlowFilt', models.FloatField(help_text='The beer slow filter is used for the control algorithm. The frige temperature setting is calculated from this filter. Because a small difference in beer temperature cases a large adjustment in the fridge temperature, more smoothing is needed', verbose_name='Beer slow filter delay time')),
                ('beerSlopeFilt', models.FloatField(help_text='The slope is calculated every 30 sec and fed to this filter. More filtering means a smoother frige setting.', verbose_name='Beer slope filter delay time')),
                ('fridgeFastFilt', models.FloatField(help_text='The fridge fast filter is used for on-off control, display and logging. It needs to have a small delay.', verbose_name='Fridge fast filter delay time')),
                ('fridgeSlowFilt', models.FloatField(help_text='The fridge slow filter is used for peak detection to adjust the overshoot estimators. More smoothing is needed to prevent small fluctiations to be recognized as peaks.', verbose_name='Fridge slow filter delay time')),
                ('fridgeSlopeFilt', models.FloatField(help_text='Not used?', verbose_name='Fidlge slope filter delay time')),
                ('lah', models.FloatField(choices=[('Y', 'YES'), ('N', 'No')], default='N', help_text='If this options is set to Yes the light will be used as a heater', verbose_name='Use light as heater?')),
                ('hs', models.FloatField()),
                ('preset_name', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('controller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.BrewPiDevice')),
                ('tempFormat', models.CharField(choices=[('F', 'Farenheit'), ('C', 'Celcius')], default='F', max_length=1, verbose_name='Temperature format')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='brewpidevice',
            name='status',
            field=models.CharField(choices=[('active', 'Active, Managed by Circus'), ('unmanaged', 'Active, NOT managed by Circus'), ('disabled', 'Explicitly disabled, cannot be launched'), ('updating', 'Disabled, pending an update')], default='active', max_length=15),
        ),
    ]
