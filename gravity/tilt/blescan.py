        ...
        if event == bluez.EVT_INQUIRY_RESULT_WITH_RSSI:
            ...
            if subevent == EVT_LE_CONN_COMPLETE:
                ...
                for i in range(0, num_reports):
                    ...
                    Adstring += ','
                    Adstring += "{:d}".format(returnnumberpacket(pkt[report_pkt_offset -6: report_pkt_offset - 4]))
                    Adstring += ','
                    Adstring += "{:d}".format(returnnumberpacket(pkt[report_pkt_offset -4: report_pkt_offset - 2]))
                    try:
