...
firmware_flash_urlpatterns = [
    ...
    url(r'^gravity/$', firmware_flash.views.firmware_select_family, name='firmware_flash_select_family'),
    url(r'^gravity/add/$', firmware_flash.views.firmware_refresh_list, name='firmware_flash_refresh_list'),
