# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-11-18 14:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('black', 'Black'), ('orange', 'Orange'), ('green', 'Green'), ('blue', 'Blue'), ('purple', 'Purple'), ('red', 'Red'), ('yellow', 'Yellow'), ('pink', 'Pink')], max_length=32, unique=True)),
